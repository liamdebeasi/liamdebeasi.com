...
$(".logo").click(function(){return $("nav #main").click(),!1}),"addEventListener"in document&&document.addEventListener("DOMContentLoaded",function(){FastClick.attach(document.body)},!1),$("input[type=checkbox]").click(function(){try{$(this).is(":checked")?($(document).off("touchmove"),$(document).on("touchmove",function(e){e.preventDefault()})):$(document).off("touchmove")}catch(e){}}),$("nav a").click(function(){var e=$(".container-fluid.active").attr("id"),a=$(this).attr("id");$("input[type=checkbox]").prop("checked",!1),$(document).off("touchmove"),e!=a&&("main"==e?$(".container-fluid#"+e).removeClass("scaleIn").removeClass("scaleInNoDelay").addClass("scaleOut"):($(".container-fluid#"+e).removeClass("fadeIn").addClass("fadeOut"),"page"==e&&($("body").removeClass("dark"),$("footer").removeClass("hide").addClass("fadeIn"))),setTimeout(function(){$("body").scrollTop(0),"main"==e?$(".container-fluid#"+e).removeClass("scaleOut").removeClass("active").addClass("hide"):$(".container-fluid#"+e).removeClass("fadeOut").removeClass("active").addClass("hide"),"main"==a?$(".container-fluid#"+a).addClass("scaleInNoDelay").removeClass("hide").addClass("active"):$(".container-fluid#"+a).addClass("fadeIn").removeClass("hide").addClass("active")},250))}),$(".image#me").click(function(){$(".me-full").addClass("scaleInNoDelayFast").removeClass("hide")}),$(".me-full").click(function(){$(this).removeClass("scaleInNoDelayFast").addClass("scaleOutFast"),setTimeout(function(){$(".me-full").removeClass("scaleOutFast").addClass("hide")},200)}),$(".item").click(function(){var e=$(this).data("file"),a=$(this).data("theme");$(".container-fluid#main").removeClass("scaleIn").removeClass("scaleInNoDelay").removeClass("scaleIn").addClass("scaleOut"),$("footer").addClass("fadeOut"),"dark"==a&&$("body").addClass("dark"),setTimeout(function(){$(".container-fluid#main").removeClass("scaleOut").addClass("hide").removeClass("active"),$("footer").removeClass("fadeOut").addClass("hide"),$("body").scrollTop(0),$(".container-fluid#page").load("pages/"+e,function(){$(".container-fluid#page").removeClass("hide"),setTimeout(function(){$(".container-fluid#page").addClass("active"),$(".container-fluid#page").addClass("fadeIn")},250)})},250)}),$("#me, .hero").show();
