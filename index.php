...
<html>
    ...
    <body class="trans">
        <header class="trans">
            ...
            <nav class="navTouch">
                <ul>
                    <a class="trans active" href="#" id="main"><li class="trans">home</li></a>
                    <a class="trans" href="#" id="about"><li class="trans">about</li></a>
                </ul>
        ...
        <div class="container-fluid hide" id="about">
            <div class="hero">
                <div class="image transFast" id="me"></div>
            </div>
            
            <div class="me-full hide"></div>
            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        <h1>About Me</h1>
                        <p>
                            Hi there, I'm Liam DeBeasi! I am a full stack developer who builds powerful and beautifully designed web and mobile applications. I am currently pursuing a degree in Computer Science at Boston University and will graduate in May 2017.
                        </p>
                    </div>
                </div>
            </section>
